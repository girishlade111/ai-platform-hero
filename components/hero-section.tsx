    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-black via-black to-blue-950">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <nav className="hidden ml-12 space-x-8 md:flex">
              {["Products", "Leaderboards", "Enterprise", "Government", "Customers", "Resources"].map((item) => (
                <Link
                  key={item}
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-6 pt-20 pb-32 mx-auto text-center max-w-7xl">
        ...
        <p className="max-w-2xl mx-auto mt-6 text-lg text-gray-300">
          We provide the data and tools to build, train,
          <br />
          and deploy advanced AI models at scale.
        </p>
        ...
        <div className="w-full mt-24">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
            ...
            <div className="h-6 text-white">
              <span className="text-xl font-bold">cohere</span>
            </div>
            <div className="h-8 text-white">
